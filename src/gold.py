...
# Import your logger and create a module-level logger
...
def create_daily_revenue():
    ...
    try: 
        ...
        # Create daily_revenue using SQL
        ...
        logger.error(f"Failed to create daily revenue: {e}")
        raise
...
def create_product_performance():
    ...
    try:
        ...
        logger.error(f"Failed to create product performance: {e}")
        raise
...
def create_customer_ltv():
    ...
    try:
        ...
        logger.error(f"Failed to customer ltv: {e}")
        raise
...
def create_gold_layer():
    ...
    # Call each Gold creation function
